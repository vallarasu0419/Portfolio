...
const experiences = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        tech: ['React.js', 'Redux', 'Node.js', 'Express.js', 'MySQL', 'Socket.IO', 'MS Teams API'],
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        tech: ['React.js', 'React Native', 'Node.js', 'Express.js', 'AWS', 'MySQL'],
      },
    ],
  },
];
            ...
            >
              ...
              {exp.projects.map((proj, projIdx) => (
                <motion.div
                  ...
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ delay: expIdx * 0.2 + projIdx * 0.15 + 0.4, duration: 0.5 }}
                  style={{
                    marginTop: '20px',
                    padding: '24px',
